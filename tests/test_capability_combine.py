...
COMBINE_POLICY: dict[str, Policy] = {
    ...
    'E2BSandbox': Rejected('multiple E2B workspace suppliers require explicit selection'),
    'DaytonaSandbox': Rejected('multiple Daytona workspace suppliers require explicit selection'),
    'SpriteWorkspace': Rejected('multiple Sprite workspace suppliers require explicit selection'),
