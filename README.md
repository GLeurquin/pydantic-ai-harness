...
| [Jev Capability Composer](pydantic_ai_harness/jev/) | Harness | Jev picks a sub-agent's model, thinking effort, and capabilities per prompt from an allowlist, and hands it the turn |
