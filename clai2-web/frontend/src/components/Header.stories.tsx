...
export const ConnectedWithApprovals: Story = () => (
  <div style={{ border: '1px solid var(--border)' }}>
    <Header connected={true} approvals={approvals} agents={agents} onResolveApproval={noop} onManageModels={noop} onToggleSidebar={noop} />
...
export const Disconnected: Story = () => (
  <div style={{ border: '1px solid var(--border)' }}>
    <Header connected={false} approvals={[]} agents={[]} onResolveApproval={noop} onManageModels={noop} onToggleSidebar={noop} />
    <div style={{ height: 200 }} />
  </div>
);
