...
Storing an agent's notes as well as its messages? [Memory](memory.md#one-database-for-both) shows both capabilities pointed at one database; they write disjoint tables and stay separate capabilities.
