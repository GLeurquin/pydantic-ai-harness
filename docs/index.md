...
description: "Your agent's favorite harness, built on Pydantic AI: an open source (MIT) library of 30+ capabilities and complete agents assembled from them, from a coding agent to your own custom stack."
---
